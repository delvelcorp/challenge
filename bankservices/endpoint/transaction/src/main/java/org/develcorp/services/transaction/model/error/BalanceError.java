...
public class BalanceError {
    ...
    private static final String ERROR_DETAIL_001 = "Balance not found.";

    private static final String ERROR_CODE_002 = "E002";
    private static final String ERROR_DETAIL_002 = "Balance already exist.";

    private static final String ERROR_CODE_003 = "E003";
    private static final String ERROR_DETAIL_003 = "Balance information is incomplete.";

    private static final String ERROR_CODE_004 = "E004";
    private static final String ERROR_DETAIL_004 = "Balance not can delete, that is actually referred from the database.";
